...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/qt/QtSql/5.6.3"
        "${_qt5Sql_install_prefix}/include/qt/QtSql/5.6.3/QtSql"
    )
    ...
    _populate_Sql_target_properties(RELEASE "libQt5Sql.so.5.6.3" "" )

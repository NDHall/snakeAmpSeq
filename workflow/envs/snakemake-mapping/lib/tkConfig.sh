...
# installed.
TK_PREFIX='/home/ndh0004/anaconda3/envs/snakemake-mapping'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/ndh0004/anaconda3/envs/snakemake-mapping'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/ndh0004/anaconda3/envs/snakemake-mapping/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/ndh0004/anaconda3/envs/snakemake-mapping/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/ndh0004/anaconda3/envs/snakemake-mapping/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/home/ndh0004/anaconda3/envs/snakemake-mapping/lib/libtkstub8.6.a'

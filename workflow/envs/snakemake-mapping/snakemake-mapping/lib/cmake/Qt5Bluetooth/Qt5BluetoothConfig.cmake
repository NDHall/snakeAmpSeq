...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.6.3"
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.6.3/QtBluetooth"
    )
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.so.5.6.3" "" )

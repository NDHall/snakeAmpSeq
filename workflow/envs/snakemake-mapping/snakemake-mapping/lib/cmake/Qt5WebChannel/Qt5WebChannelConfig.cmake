...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/qt/QtWebChannel/5.6.3"
        "${_qt5WebChannel_install_prefix}/include/qt/QtWebChannel/5.6.3/QtWebChannel"
    )
    ...
    _populate_WebChannel_target_properties(RELEASE "libQt5WebChannel.so.5.6.3" "" )

...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/qt/QtNetwork/5.6.3"
        "${_qt5Network_install_prefix}/include/qt/QtNetwork/5.6.3/QtNetwork"
    )
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.6.3" "" )

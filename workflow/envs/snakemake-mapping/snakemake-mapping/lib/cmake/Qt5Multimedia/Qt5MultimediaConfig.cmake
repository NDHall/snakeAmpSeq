...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/qt/QtMultimedia/5.6.3"
        "${_qt5Multimedia_install_prefix}/include/qt/QtMultimedia/5.6.3/QtMultimedia"
    )
    ...
    _populate_Multimedia_target_properties(RELEASE "libQt5Multimedia.so.5.6.3" "" )
